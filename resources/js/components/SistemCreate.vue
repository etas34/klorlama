                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input ref="clear" type="text" required name="ad" class="form-control" v-model="formData.ad">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Telefon Numarası</label>
                                    <input ref="clear" type="text" v-mask="'0 (###) ###-####'" required name="telefon" class="form-control" v-model="formData.telefon">
